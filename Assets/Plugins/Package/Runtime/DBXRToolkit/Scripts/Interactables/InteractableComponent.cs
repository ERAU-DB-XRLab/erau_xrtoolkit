...
public class InteractableComponent : MonoBehaviour
{
    ...
    [HideInInspector]
    public UnityEvent<HandInteract> Grabbed, Dropped, InteractStarted, InteractStopped, HandEntered, HandExited, PointerEntered, PointerExited, RayEntered, RayExited, RayInteractStarted, RayInteractStopped;
    ...
    protected void Awake()
    {
        ...
        RayInteractStarted.AddListener(delegate {
            Debug.Log("ENTERED");
        });
        RayInteractStopped.AddListener(delegate {
            Debug.Log("EXITED");
        });
    }
