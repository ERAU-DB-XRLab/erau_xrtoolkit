...
public class HandControllerInteract : HandInteract
{
    ...
    [SerializeField] protected HandAnimator anim;
    ...
    public void ClampToOverride()
    {
        ...
        handTransform.rotation = Quaternion.LookRotation(-handOverride.up, handOverride.right * (handType == HandType.RIGHT ? -1 : 1));
    }
